...
if(isset($_POST['insert_record'])) {
    ...
    $stmt = oci_parse($conn, 'INSERT INTO camera (Rover_ID,Camera_Type,Focal_Length,FieldOfView,No_Of_Pixels,Memory) VALUES (:Rover_ID,:Camera_Type,:Focal_Length,:FieldOfView,:No_Of_Pixels,:Memory)');
